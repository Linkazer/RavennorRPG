...
public enum EffectTrigger { Apply, End, DamageTakenSelf, DamageDealSelf, DamageDealTarget, Heal, DoAction, Die, BeginTurn, EnterNode, ExitNode, EndTurn, DamageTakenAttacker}
